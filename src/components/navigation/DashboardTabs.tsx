...
const TABS = [
  ...
  { label: "Evidence", href: "/dashboard/research" },
] as const;
...
export function DashboardTabs() {
  ...
  return (
    <nav
      ...
      className="w-full border-b border-[#e5e5e3] bg-[#fdfcfc]"
    >
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "border-[#0a0e1a] text-[#0a0e1a]"
                    : "border-transparent text-[#9ca3af] hover:text-[#0a0e1a] hover:border-[#e5e5e3]"
                )}
